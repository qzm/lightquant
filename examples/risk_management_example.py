...
def create_test_order(symbol="BTC/USDT", order_type=OrderType.LIMIT, side=OrderSide.BUY, 
...
def test_position_size_rule():
    ...
    print(f"更新规则后，订单2 (0.3 BTC, 价值15000 USDT): {'通过' if result4 else '拒绝'}")
